...
export function RecipeCard({
  ...
  return (
    <>
      <article className="flex flex-col md:flex-row shadow-xl rounded-xl overflow-hidden transition-all hover:shadow-xl/30 md:pb-3">
        ...
        <div className="px-5 pt-2 flex gap-2 text-xs text-gray-500">
          <div>
            <h3 className="font-extrabold text-gray-800">Ingredients</h3>
            <ul>
          ...
          <div>
            <h3 className="font-extrabold text-gray-800">Measures</h3>
            <ul>
        ...
        <div className="flex md:flex-col justify-between">
          <div className="px-5 pt-2 flex-col gap-2 text-xs text-gray-700">
            <h3 className="font-extrabold text-gray-800">Instructions</h3>
            <p className="max-h-20 overflow-y-auto">{strInstructions}</p>
          </div>
          <div className="px-3 pt-2 pb-4 flex-col gap-2 text-xs text-gray-700">
            <div className="flex flex-col md:flex-row md:gap-3">
              <div>
                <h3 className="font-extrabold text-gray-800">Details</h3>
              ...
              <div>
                <h3 className="font-extrabold text-gray-800 pt-2 md:pt-0">Tags</h3>
                <p className="px-2">{strTags}</p>
              </div>
            </div>
            <h3 className="font-extrabold text-gray-800 pt-2">YouTube</h3>
            <a
              href={strYoutube}
              target="_blank"
