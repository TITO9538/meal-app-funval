...
export function Search() {
  ...
  return (
    ...
    <div className="dark:bg-[#7E2F17] transition-colors duration-500 ease-in-out">
      ...
      >
        <h1
          className="text-3xl font-bold text-center mb-6 text-[#4C2A20] dark:text-yellow-100 transition-colors duration-500 ease-in-out"
        >
        ...
        <h2
          className="text-2xl font-semibold mt-10 mb-4 text-[#4C2A20] dark:text-yellow-100 transition-colors duration-500 ease-in-out"
        >
